        ...
        <div class="container-fluid">
            <div class="row" v-if="can('pacientes_create')">
                <div class="col-lg-6 col-10">
                    <button class="btn btn-primary btn-sm" @click.stop="newpaciente"><i class="fa-solid fa-user-plus"></i> Nuevo paciente</button>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-hover table-sm">
                                ...
                                <tbody>
                                    <tr v-for="user in Listauser.data" :key="user.id" v-if="user.name=='Paciente'">
...
import Modalnewpaciente from './modalnewpaciente.vue';
